                            ...
                            <Grid container spacing={2}>
                              <Grid item xs={6}>
                                <Grid container spacing={2}>
                                  ...
                                  <Grid item xs={8}>
                                    {renType(data.paymentType)} (
                                    {renPayment(data.paymentStatus)})
                                  </Grid>
                                </Grid>
                              </Grid>
                            </Grid>
                            ...
                            <Grid container spacing={2}>
                              <Grid item xs={6}>
                                ...
                                <p>
                                  Tổng phí hóa đơn:{" "}
                                  {formatCurrencyVND(
                                    String(data.totalAmount + data.shipFee),
                                  )}
                                </p>
                              </Grid>
                              <Grid item xs={6}>
                                <p>
                                  ...
                                  {data.user?.username +
                                    " " +
                                    (data.user?.accountName || "Không rõ")}
                                </p>
                                <p> Số điện thoại: {data.user?.sdt}</p>
                                <p>
                                  {" "}
                                  Gmail: {data.user?.email || "Chưa xác thực"}
                                </p>
                                <p>
                                  {" "}
                                  Đích đến: {data.sendTo || "Chưa xác thực"}
                                </p>
                              </Grid>
                            </Grid>
                          </Box>
