...
import {Backdrop, Box, Button, Grid, IconButton, Input, Stack,} from "@mui/material"
                    ...
                    {imagePreview ? (
                      <>
                        ...
                        >
                          ...
                          />
                          <div
                            className="absolute tool-img top-0 left-0 hidden items-center justify-center w-[100%] h-[100%] bg-[rgba(0,0,0,0.5)] z-10">
