...
export function AuthCard(props: AuthCardProps) {
  ...
  const [code, setCode] = useState("Chưa xác nhận được mã người dùng")
  ...
  function resetClick() {
    codeReader.reset()
    setCode("Chưa xác nhận được mã người dùng")
    setNext(false)
  ...
  useEffect(() => {
    if (code != "Chưa xác nhận được mã người dùng") {
