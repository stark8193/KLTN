...
import com.apec.pos.dto.billDTO.*;
...
public class BillService extends BaseService<BillRepository, BillEntity, Integer> implements BillInterface {
    ...
    public AddBillResponse addBill(BillRequest billRequest, String username) throws Exception {
        ...
        BillEntity result = BillEntity.builder()
                ...
                .paymentStatus(billRequest.getPaymentStatus())
                .paymentType(billRequest.getPaymentType())
        ...
        List<VoucherEntity> vouchers = voucherReposioty.findAll();

        return new AddBillResponse(result, vouchers);
    }
    ...
    public BillEntity updateBill(OrderStatus orderStatus, Integer id) {
        ...
        if (orderStatus.equals(OrderStatus.DELIVERED)) {
            ...
            billEntity.setPaymentStatus(PaymentStatus.PAID);
    ...
    public void updateBillOnline(PaymentStatus paymentStatus, Integer id) {
        ...
        if(paymentStatus.equals(PaymentStatus.PAID)){
            ...
            billEntity.setPaymentStatus(PaymentStatus.UNPAID);
